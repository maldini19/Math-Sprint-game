...
function updateBestScore() {
  bestScoreArray.forEach((score, index) => {
    ...
    if (questionAmount == score.questions) {
      ...
      // Update if the new final score is less or replacing with new best score
...
// Scroll, Store user selection i platyerGuessArray
...
// Form that decice amount of questions
